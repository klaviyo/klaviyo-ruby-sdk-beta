...
module KlaviyoBeta
  class SegmentsApi
    ...
    # Get Segment
    # Get a single segment by ID<br><br>*Rate limits*:<br>Burst: `10/s`<br>Steady: `150/m`
    # @param id [String] 
    ...
    # Returns a list of all profiles inside a given segment, that can optionally be filtered by email, phone number, and push token.
    ...
    # Returns a list of profile membership relationships for a given segment
    # @param id [String] 
    ...
    # Get Segments
    # Get some or all segments.<br><br>*Rate limits*:<br>Burst: `10/s`<br>Steady: `150/m`
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :fields_segment For more information please visit https://developers.klaviyo.com/en/v2022-09-07.pre/reference/api-overview#filtering
    ...
    # Update Segment
    # Update segment name or other attributes by ID.<br><br>*Rate limits*:<br>Burst: `10/s`<br>Steady: `150/m`
    # @param id [String] 
